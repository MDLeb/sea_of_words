...
import { _decorator, Component, Enum, UITransform, Size, Vec2, v2, View, view, Director, director, size, Node, UIOpacity, screen, CCFloat } from 'cc';
...
export class TransformAdapter extends Component {
	...
	onTransformEvent() {
		const transformFunc = () => {
			...
			const isHorizontal: boolean = viewSize.width /  viewSize.height > this.horizontalAspect;
